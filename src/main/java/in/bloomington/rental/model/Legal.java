...
public class Legal implements java.io.Serializable
{
    ...
    {
        if (val != null) pullReason = val.trim();
    }

    public void setStartDate(String val)
    {
        if (val != null) startDate = val;
    }
    ...
    {
        if (vals != null) owner_ids = vals;
    }

    public void setAddress_ids(Integer[] vals)
    {
        if (vals != null) address_ids = vals;
    }
    ...
    {
        if (val != null) startByName = val.trim();
    }
    ...
    {
        if (val != null) case_type = val.trim();
    }
    ...
    {
        String ret = "";
        if (rental_id > 0)         { ret += "rental_id:" + rental_id; }
        if (!   reason.equals("")) { ret += "reason:"    + reason;    }
        if (!startDate.equals("")) { ret += "date:"      + startDate; }
        if (!  startBy.equals("")) { ret += "startBy:"   + startBy;   }
        if (!case_type.equals("")) { ret += "type:"      + case_type; }
        return ret;
    }
    ...
    {
        int ret = 17;
        if (rental_id > 0) { ret += 37 * rental_id; }
        return ret;
    }
}
