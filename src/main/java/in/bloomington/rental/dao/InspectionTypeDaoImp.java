...
public class InspectionTypeDaoImp implements InspectionTypeDao {
   ...
   public InspectionType get(int id) {
      return sessionFactory.getCurrentSession().get(InspectionType.class, id);
   }
   @Override
   ...
   public List<InspectionType> list() {
      ...
      TypedQuery<InspectionType> query = sessionFactory.getCurrentSession().createQuery("from InspectionType");
