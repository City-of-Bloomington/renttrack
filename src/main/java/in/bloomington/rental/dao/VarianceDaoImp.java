...
public class VarianceDaoImp implements VarianceDao{
    ...
    public void delete(int id) {
        Variance variance = (Variance) sessionFactory.getCurrentSession().load(
                Variance.class, id);
        if (variance != null) {
            this.sessionFactory.getCurrentSession().delete(variance);
        }
    }
		@Override		
		...
		//
		public List<Variance> find(String rental_id,
															 String text,
															 String dateFrom,
															 String dateTo){
