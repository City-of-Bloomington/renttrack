...
public class CanController
{
    ...
    public String editCan(@PathVariable("id") int id, Model model)
    {
    ...
    public String saveCan(@ModelAttribute("can") @Valid Can can, BindingResult result, Model model)
    {
        if (result.hasErrors()) {
...
class CanServiceController
{
    ...
    public String canService(@RequestParam("term") String term, Locale locale, Model model)
    {
        String json = "";
