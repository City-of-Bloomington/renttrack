...
<body>
  <fieldset>
    <legend>Edit Egress</legend>
    <form:form action="${uri}settings/egressUpdate" method="post" modelAttribute="egress">
			<form:hidden path="id" />
			<details>
				...
				<ul>
					<li>Start year and end year are in 4 digit format, such as 1992</li>
						...
						<li>For multi family buildings, sometimes openable area for the first floor is different the other floors</li>
				</ul>
			</details>
      <table>
        <tr>
