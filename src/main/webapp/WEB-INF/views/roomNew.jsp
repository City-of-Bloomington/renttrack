...
<body>
  <fieldset>
    <legend>New Unit Room</legend>
		<details>
			<summary>Instructions</summary>
			<ul>
				<li>Rooms are bedrooms, kitchen, living room </li>
    ...
    <form:form action="${uri}roomSave" method="post" modelAttribute="room">
			<form:hidden path="rentalUnit.id" />
      <table>
				<tr>
					<th>Related Unit</th>
					<td>
						<a href="${uri}rentalUnit/${room.rentalUnit.id}">${room.rentalUnit.id}</a>
					</td>
				</tr>
        <tr>
          <th>Identifier</th>
