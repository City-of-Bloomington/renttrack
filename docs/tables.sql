...
create table bills(                                                                id serial primary key,                                                          rental_id int,                                                                  issue_date date,                                                                due_date  date,                                                                 building_rate  decimal(6,2),                                                                                                                                    unit_rate decimal(6,2),                                                         bath_rate decimal(6,2),                                                         reinsp_rate decimal(6,2),                                                       noshow_rate decimal(6,2),                                                       bhqa_fine   decimal(6,2),                                                                                                                                       building_cnt  smallint,                                                         unit_cnt smallint,                                                              bath_cnt smallint,                                                              noshow_cnt smallint,                                                            reinsp_cnt smallint,                                                                                                                                            reinsp_dates varchar(80),                                                       noshow_dates varchar(80),                                                       status varchar(15),                                                             appeal char(1),                                                                 appeal_fee decimal(6,2),                                                                                                                                        credit decimal(6,2),                                                            summary_rate decimal(6,2),                                                      idl_rate decimal(6,2),                                                          summary_flag char(1),                                                           idl_flag char(1),                                                                                                                                               summary_cnt smallint,                                                           idl_cnt smallint,                                                               foreign key(rental_id) references rentals(id)                                  );
